...
- (nullable NSString *)flutterSendMessageMsg:(F2NMessage *)msg error:(FlutterError *_Nullable *_Nonnull)error;
@end
...
- (void)nativeSendMessageMsg:(N2FMessage *)msg completion:(void (^)(NSString *_Nullable, FlutterError *_Nullable))completion;
@end
